 ...
 */
class UpscaleDiffusionPrompt2InputView extends UpscaleDiffusionPromptInputView {
    /**
     * @var string The tooltip to show
     */
...
UpscaleDiffusionPrompt2InputView,
UpscaleDiffusionNegativePromptInputView,
UpscaleDiffusionNegativePrompt2InputView,
    ...
    static fieldSets = {
        ...
        "Upscale Diffusion": {
            ...
            "upscaleDiffusionPrompt2": {
                ...
                "class": UpscaleDiffusionPrompt2InputView
            },
            ...
            "upscaleDiffusionNegativePrompt2": {
                ...
                "class": UpscaleDiffusionNegativePrompt2InputView
            },
