# type: ignore
# Adapted from https://raw.githubusercontent.com/patrickvonplaten/controlnet_aux/master/src/controlnet_aux/midas/__init__.py
import cv2
import numpy as np
import torch
...
from enfugue.diffusion.support.depth.midas.inference import MiDaSInference
...
class MidasDetector:
    ...
    @classmethod
    def from_pretrained(cls, model_path, model_type="dpt_hybrid"):
