...
class FaceIDLoRAAttentionProcessor(nn.Module):
    r"""
    Default processor for performing attention-related computations.
    """
...
class FaceIDLoRAIPAttentionProcessor(nn.Module):
    r"""
    Attention processor for IP-Adapater.
    Args:
        hidden_size (`int`):
...
class FaceIDLoRAAttentionProcessor2_0(nn.Module):
...
class FaceIDLoRAIPAttentionProcessor2_0(nn.Module):
    r"""
