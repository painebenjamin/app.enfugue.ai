...
from enfugue.diffusion.animate.dragnuwa.svd.util import default, instantiate_from_config
from enfugue.diffusion.animate.dragnuwa.svd.modules.autoencoding.lpips.loss.lpips import LPIPS
from enfugue.diffusion.animate.dragnuwa.svd.modules.autoencoding.lpips.model.model import weights_init
from enfugue.diffusion.animate.dragnuwa.svd.modules.autoencoding.lpips.vqperceptual import hinge_d_loss, vanilla_d_loss
...
class GeneralLPIPSWithDiscriminator(nn.Module):
    def __init__(
        ...
        discriminator_config = default(
            ...
            {
                "target": "enfugue.diffusion.animate.dragnuwa.svd.modules.autoencoding.lpips.model.model.NLayerDiscriminator",
                "params": {
