...
from enfugue.diffusion.animate.dragnuwa.svd.modules.autoencoding.regularizers import AbstractRegularizer
from enfugue.diffusion.animate.dragnuwa.svd.modules.ema import LitEma
...
class AbstractAutoencoder(pl.LightningModule):
    ...
    def apply_ckpt(self, ckpt: Union[None, str, dict]):
        ...
        if isinstance(ckpt, str):
            ckpt = {
                "target": "enfugue.diffusion.animate.dragnuwa.svd.modules.checkpoint.CheckpointEngine",
...
class AutoencodingEngineLegacy(AutoencodingEngine):
    def __init__(self, embed_dim: int, **kwargs):
        ...
        super().__init__(
            ...
            decoder_config={
                "target": "enfugue.diffusion.animate.dragnuwa.svd.modules.diffusionmodules.model.Decoder",
                "params": ddconfig,
            },
            **kwargs,
        )
...
class AutoencoderKL(AutoencodingEngineLegacy):
    def __init__(self, **kwargs):
        ...
        super().__init__(
            regularizer_config={
                "target": (
                    "enfugue.diffusion.animate.dragnuwa.svd.modules.autoencoding.regularizers.DiagonalGaussianRegularizer"
                )
            },
            **kwargs,
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            regularizer_config={
                "target": (
                    "enfugue.diffusion.animate.dragnuwa.svd.modules.autoencoding.regularizers.quantize.VectorQuantizer"
                ),
                "params": {
                    "n_e": n_embed,
                    "e_dim": embed_dim,
...
class AutoencoderKLModeOnly(AutoencodingEngineLegacy):
    def __init__(self, **kwargs):
        ...
        super().__init__(
            regularizer_config={
                "target": (
                    "enfugue.diffusion.animate.dragnuwa.svd.modules.autoencoding.regularizers"
